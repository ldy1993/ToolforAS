...
public class ConstantData {
    ...
    public static final String[][] CHILD_NAMES = new String[][] {
            new String[] {"银行卡识别", "调用sdk扫码", "文字识别", "人证识别",
                    "人脸识别","待定1","待定2","待定3","待定4","待定5","待定6",
                    "待定7"},
            new String[] {"JNI测试","c算法","待定","待定","待定","待定","待定",
                    "待定","待定","待定","待定","待定", "待定","待定","待定",
                    "待定"},
            new String[] {"上传参数", "待定", "待定", "待定","待定","待定",
                    "待定","待定","待定","待定","待定","待定","待定","待定",
                    "待定","待定","待定"},
            ...
            new String[] {"Activity的传值和回传","创建控件view和布局ViewGroup",
                    ...
                    "进度条","对话框","PopupWindow","待定","待定","待定",
                    "待定","待定","待定","待定"},
            new String[] {"RSA","保险箱计算密码","待定","待定","待定","待定",
                    "待定","待定","待定/待定","待定","待定","待定",
                    "待定","待定","待定","待定"},
            new String[] {"登录界面","菜单界面","金额输入界面","待定","待定",
                    "待定","待定","待定","待定/待定","待定","待定","待定",
                    "待定","待定","待定","待定"},
            new String[] {"日志上传","待定","待定","待定","待定","待定","待定",
                    "待定","待定/待定","待定","待定","待定",
                    "待定","待定","待定"},
            new String[] {"待定","待定","待定","待定","待定","待定","待定",
                    "待定","待定/待定","待定","待定","待定",
                    "待定","待定","待定","待定"},
            new String[] {"待定","待定","待定","待定","KTV","待定",
                    "待定","待定","待定/待定","待定","待定","待定",
                    "待定","待定","待定"},
    };
