...
public enum SonMenuEnum {
    ...
    界面跳转("界面跳转", 2, R.drawable.ic_category_0),
    创建控件("创建控件view和布局ViewGroup", 3, R.drawable.ic_category_0),
    自定义view("自定义view", 4, R.drawable.ic_category_0),
    基础ListView("基础ListView", 5, R.drawable.ic_category_0),
    可以左滑的listview("可以左滑的listview", 6, R.drawable.ic_category_0),
    进度条("进度条", 7, R.drawable.ic_category_0),
    对话框("对话框", 8, R.drawable.ic_category_0),
    POPUPWINDOW("POPUPWINDOW", 9, R.drawable.ic_category_0),
    基于线程池的异步任务("基于线程池的异步任务", 10, R.drawable.ic_category_0),
    异步任务下的网络请求("异步任务下的网络请求", 11, R.drawable.ic_category_0),
    静态fragment("静态fragment", 12, R.drawable.ic_category_0),
    设计模式("设计模式", 13, R.drawable.ic_category_0),
