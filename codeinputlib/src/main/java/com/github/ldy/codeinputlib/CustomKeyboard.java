package com.github.ldy.codeinputlib;
...
import com.github.ldy.Utils.UnitUtils;
...
public class CustomKeyboard extends KeyboardView {
	...
	public CodeInput getCurrentView() {
		return currentView;
	}

	public void setCurrentView(CodeInput currentView) {
