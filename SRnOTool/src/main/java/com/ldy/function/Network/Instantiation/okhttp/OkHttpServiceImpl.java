 ...
 * ================================================
 */
public class OkHttpServiceImpl implements ICommunicationManager {
    ...
    @Override
    public void postParamsOrFile(final File file, final Map<String, Object> params, final String url, final NetComplateListener listener) {
